...
class Dataset1():
    def __init__(self, status_df, clinical_df, molecular_df, clinical_df_sub, molecular_df_sub, min_occurences=5):
        ...
        self.X_sum = np.sum(self.X.astype(bool), axis=0)
        ...
        self.X_original_columns = self.X.columns
        '''
        ...
        self.sparse_features = sparse_features[self.X_sum < min_occurences]
        ...
        self.X_sub_original_columns = self.X_sub.columns
        self.X_sum_sub = np.sum(np.array(self.X_sub).astype(bool), axis=0)
        sparse_features_sub = self.X_sub.columns
        self.sparse_features_sub = sparse_features_sub[self.X_sum_sub < min_occurences/3]
